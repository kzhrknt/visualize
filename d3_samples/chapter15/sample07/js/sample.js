...
d3.json("data/world.json", function(error, world) {
	d3.select("#myGraph")
		.append("circle")	// 地球は丸いので円を追加
		.attr("cx", svgWidth/2)	// 表示画面の中央を中心X座標にする
		.attr("cy", svgHeight/2)	// 表示画面の中央を中心Y座標にする
		.attr("r", earthSize)	// 表示する地球の半径を指定する
		.style("fill", "blue")	// 青い地球にする
